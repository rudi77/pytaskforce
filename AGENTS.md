...
- Document extraction agent templates and tool stubs live in `plugins/document_extraction_agent/`, with supporting prompt/tool sketches in `docs/templates/document_extraction/`.
