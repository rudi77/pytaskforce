...
This directory contains records of significant technical decisions made during the development of Taskforce.

## 📑 Records

- **[ADR 001: Use uv as Package Manager](adr-001-uv-as-package-manager.md)**
- **[ADR 002: Clean Architecture Layering](adr-002-clean-architecture-layers.md)**
- **[ADR 003: Enterprise Transformation](adr-003-enterprise-transformation.md)**
...
- **[ADR 024: Standing Goals — proactive long-running objectives](adr-024-standing-goals.md)**
- **[ADR 025: Tool-result context isolation and content-filter recovery](adr-025-tool-result-context-isolation.md)**
