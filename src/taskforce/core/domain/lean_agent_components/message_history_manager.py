...
Keep it factual and concise."""
        ...
        try:
            ...
            keep_from = self._sanitizer.adjust_keep_boundary_for_tool_pairs(
            ...
            return self._sanitizer.drop_orphan_tool_messages(compressed)
    ...
    def deterministic_compression(self, messages: list[dict[str, Any]]) -> list[dict[str, Any]]:
        ...
        # Keep last 10 messages, preserving tool-call pairs
        trimmed = self._sanitizer.keep_recent_preserving_tool_pairs(messages, keep_last_n=10)
    ...
    async def preflight_budget_check(
        ...
        if self._token_budgeter.is_over_budget(
            ...
            emergency_truncated = self._sanitizer.keep_recent_preserving_tool_pairs(
        ...
        return self._sanitizer.drop_orphan_tool_messages(sanitized)
