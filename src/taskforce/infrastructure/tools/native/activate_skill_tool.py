...
class ActivateSkillTool(BaseTool):
    ...
    def _resolve_resume_input(
        ...
        *,
        ...
        Workflow checkpoint/resume support has been moved to agent packages.
    ...
    def _create_wait_checkpoint(
        ...
        *,
        ...
        Workflow checkpoint support has been moved to agent packages.
        This stub raises to signal the feature is unavailable.
        """
