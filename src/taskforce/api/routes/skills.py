...
The write surface (``POST /skills`` to upload a SKILL.md) lives in the
enterprise plugin (``taskforce_enterprise.api.routes.admin.skills``)
because it carries audit + permission semantics — see ADR-022 §6.
"""
