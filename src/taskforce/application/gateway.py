...
from taskforce.core.domain.multimodal import build_multimodal_content
...
# ``core/domain/multimodal.py`` so the tool-result message factory can
# reuse the exact same attachment → multimodal-content translation.
_build_multimodal_content = build_multimodal_content
