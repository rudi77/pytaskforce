"""Git operations for the optimization loop.
...
class GitManager:
    """Manages git operations for optimization experiments."""
    ...
    def commit_experiment(
        ...
        for f in files:
            self._run("add", f)
        msg = f"autooptim experiment #{experiment_id}: {description}"
    ...
    def stash_save(self, message: str = "autooptim-stash") -> bool:
