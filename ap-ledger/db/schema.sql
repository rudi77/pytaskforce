...
CREATE TABLE IF NOT EXISTS categories (
    ...
    code            TEXT    NOT NULL UNIQUE,       -- z.B. 'wareneinsatz', 'miete'
    name            TEXT    NOT NULL,              -- Anzeigename
    type            TEXT    NOT NULL CHECK (type IN ('expense', 'revenue')),
    description     TEXT,
    tax_deductible  INTEGER NOT NULL DEFAULT 1,    -- 1 = absetzbar, 0 = nicht
...
CREATE TABLE IF NOT EXISTS tax_codes (
    code        TEXT    PRIMARY KEY,               -- z.B. 'AT_20', 'AT_10'
    rate        REAL    NOT NULL,                  -- 0.20, 0.10, 0.13
    label       TEXT    NOT NULL,                  -- '20% USt', '10% USt'
    description TEXT,
    valid_from  TEXT    NOT NULL DEFAULT '2024-01-01',
    valid_to    TEXT                               -- NULL = unbefristet
);
...
CREATE TABLE IF NOT EXISTS fiscal_periods (
    ...
    label       TEXT    NOT NULL,                  -- 'Jänner 2025'
...
CREATE TABLE IF NOT EXISTS vendors (
    id              INTEGER PRIMARY KEY AUTOINCREMENT,
    name            TEXT    NOT NULL,
    name_normalized TEXT    NOT NULL,              -- Kleinbuchstaben, trim
    uid_number      TEXT,                         -- ATU-Nummer
    address         TEXT,
    default_category_code TEXT REFERENCES categories(code),
    default_tax_code      TEXT REFERENCES tax_codes(code),
    notes           TEXT,
    match_keywords  TEXT,                         -- Komma-getrennte Suchbegriffe
    created_at      TEXT    NOT NULL DEFAULT (datetime('now')),
...
CREATE TABLE IF NOT EXISTS invoices (
    id              INTEGER PRIMARY KEY AUTOINCREMENT,
    external_ref    TEXT,                          -- Rechnungsnummer des Lieferanten
    vendor_id       INTEGER REFERENCES vendors(id),
    vendor_name_raw TEXT    NOT NULL,              -- Original-Name aus Extraktion
    invoice_date    TEXT    NOT NULL,              -- YYYY-MM-DD
    due_date        TEXT,
    total_gross     REAL    NOT NULL,              -- Brutto
    total_net       REAL,                         -- Netto
    total_tax       REAL,                         -- USt-Betrag
    currency        TEXT    NOT NULL DEFAULT 'EUR',
    type            TEXT    NOT NULL DEFAULT 'invoice'
                           CHECK (type IN ('invoice', 'receipt', 'credit_note')),
    status          TEXT    NOT NULL DEFAULT 'draft'
                           CHECK (status IN ('draft', 'validated', 'posted', 'rejected')),
    source_file     TEXT,                         -- Pfad zur Original-Datei
    ...
    notes           TEXT,
    telegram_chat_id TEXT,                        -- Telegram-Chat für HITL
    telegram_message_id TEXT,                     -- Telegram-Nachricht
    created_at      TEXT    NOT NULL DEFAULT (datetime('now')),
    updated_at      TEXT    NOT NULL DEFAULT (datetime('now'))
);
...
CREATE TABLE IF NOT EXISTS journal_entries (
    ...
    entry_date      TEXT    NOT NULL,             -- Buchungsdatum
    description     TEXT    NOT NULL,
    status          TEXT    NOT NULL DEFAULT 'draft'
                           CHECK (status IN ('draft', 'posted', 'reversed')),
    fiscal_period_id INTEGER REFERENCES fiscal_periods(id),
    posted_at       TEXT,
    posted_by       TEXT,                         -- 'auto' oder 'user'
    created_at      TEXT    NOT NULL DEFAULT (datetime('now'))
);
...
CREATE TABLE IF NOT EXISTS journal_lines (
    ...
    account_code    TEXT    NOT NULL,              -- Konto-Nummer
    account_name    TEXT    NOT NULL,              -- Konto-Name
...
CREATE TABLE IF NOT EXISTS audit_log (
    id          INTEGER PRIMARY KEY AUTOINCREMENT,
    event_type  TEXT    NOT NULL,                  -- z.B. 'invoice_created', 'journal_posted'
    entity_type TEXT    NOT NULL,                  -- 'invoice', 'journal_entry'
    entity_id   INTEGER NOT NULL,
    actor       TEXT    NOT NULL DEFAULT 'system', -- 'system', 'user', 'claude'
