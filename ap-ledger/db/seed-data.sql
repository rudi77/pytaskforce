-- =============================================================================
-- Seed-Daten für AP-Ledger
-- Österreichische Friseurin / Einzelunternehmen
-- =============================================================================
...
-- -----------------------------------------------------------------------------
-- Kategorien für Friseur-Einzelunternehmen
-- -----------------------------------------------------------------------------
...
INSERT OR IGNORE INTO categories (code, name, type, description, default_tax_code, sort_order) VALUES
    ...
    ('werbung',             'Werbung & Marketing',    'expense', 'Visitenkarten, Social Media, Schild',  'AT_20', 240),
...
-- -----------------------------------------------------------------------------
-- Typische Lieferanten für Friseur-Salon
-- -----------------------------------------------------------------------------
