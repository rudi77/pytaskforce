...
The Butler is a proactive, event-driven agent daemon that runs 24/7 and acts as a personal assistant. See **[ADR-009](docs/adr/adr-009-event-driven-butler-agent.md)** for the full architecture.
