...
Usage:
  python invoice_persist.py --vendor-name-raw "Tageslosung" --invoice-date 2026-01-24 \
    --total-gross 186.00 --type receipt --source-type manual \
    --lines-json '[{"description":"Bareinnahmen","gross_amount":186.00}]'
"""
...
def main() -> None:
    ...
    if dupes:
        output({
            ...
            "duplicates": dupes,
            "message": f"Moegliches Duplikat: {len(dupes)} aehnliche Belege gefunden.",
        })
        return
